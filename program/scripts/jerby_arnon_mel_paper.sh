...
#Rscript bin/main_wrapper/subsamples_gene_classes_and_runs_enrichment_scripts.R -i tme_inputs/jerby_arnon_melanoma/paper_counts_E_xy_matrix.tsv -c tme_inputs/jerby_arnon_melanoma/gene_signatures.gmt -g tme_inputs/jerby_arnon_melanoma/paper_gold_std.tsv -o output/jam_results/ -p jam_paper_counts -t y -m CIBERSORT_BINARY -n CIBERSORT_BINARY -v y -a 0.4,1 -b 0,1 -s 100,100,0 -r 1-1 -y ranks -z 2000
